...
namespace Mammmail_WP8
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            InitializeComponent();
            ParseClient.Initialize("vHjbMcOs5ljE8uhcd0QaRCu3EK6XfSWRXBZnDG0Q", "Z7Gnt8aI2fdAHxg6WmLpDD5YthjEIYeE4FKj2stP");
        ...
        /*void SetupUriMapper()
        {
            ...
            if (!IsolatedStorageSettings.ApplicationSettings.Contains("Parse.CurrentUser"))
                mapper.UriMappings[0].MappedUri = new Uri("/MainPage.xaml?method=UriMapper&time=" + time.ToLongTimeString(), UriKind.Relative);
            else
